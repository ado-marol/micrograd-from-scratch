class Value:
    ...
    """" This class is supposed to be a scalar version of PyTorch's tensor. it stores a scalar value in self.data. """
    ...
    def relu(self): # computes reLU on self
        out = Value(0 if self.data < 0 else self.data, (self, ), 'ReLU')
        def _backward():
            self.grad += (out.data > 0) * out.grad # out.data evaluates to 0 (False) or 1 (True)
        out._backward = _backward
        return out
